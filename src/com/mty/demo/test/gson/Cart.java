...
public class Cart {
  ...
  public HashMap<Integer, LineItem> lineMap;
  ...
  public Cart(List<LineItem> lineItems, HashMap<Integer, LineItem> lineMap, String buyerName, String creditCard) {
...
//  }
  ...
  @Override
public String toString() {
	return "Cart [lineItems=" + lineItems + ", lineMap=" + lineMap
			+ ", buyerName=" + buyerName + ", creditCard=" + creditCard + "]";
}
